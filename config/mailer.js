...
module.exports.emailVerification = async function(email, name, token) {
    ...
    await module.exports.sendMail(mailData);
}
...
module.exports.resetPswd = function(email, name, token) {
    ...
    const mailData = {
        ...
        <p style="margin: 0; font-size: 18px; letter-spacing: normal;"><span style="font-size:18px;">We have received a request to reset password for your account.</span></p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;"> </p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal;"><span style="font-size:18px;"><a href="${verifyLink}" target="_blank">Click here to reset your password</a> </span></p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;"> </p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal;"><span style="font-size:18px;">Or, copy and paste the following url in your browser:</span></p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;"> </p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal;"><span style="font-size:18px;"><span><a href='${verifyLink}' target="_blank" title="reset password">${verifyLink}</a></span></p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;"> </p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal;"><span style="font-size:18px;">It can be safely ignored if you didn't request this.Password reset link will be valid for 1 hour</span></p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal; mso-line-height-alt: 14.399999999999999px;"> </p>
        <p style="margin: 0; font-size: 18px; letter-spacing: normal;"><span style="font-size:18px;">Regards<br/><strong>The Survey Gravity team</strong></span></p>
        </div>
        </div>
        </td>
        </tr>
...
const emailVerificationTemplate = function(name, verifyLink) {
    return `<!DOCTYPE html>
